...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/josepy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12665&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/josepy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `josepy` can be installed with:

```
conda install josepy
```

It is possible to list all of the versions of `josepy` available on your platform with:
